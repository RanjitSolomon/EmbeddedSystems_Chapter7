...
void WaitForASLow(void){
// write this function
	while((GPIO_PORTF_DATA_R&(0x10)) == 0x00000010)
	{
		//GPIO_PORTF_DATA_R |= 0x08;
	}
	
	if ((GPIO_PORTF_DATA_R&(0x10)) == 0x00000000)
	{			
		//GPIO_PORTF_DATA_R &= ~0x08;
		//Delay1ms(10);
...
void WaitForASHigh(void){
// write this function
	while((GPIO_PORTF_DATA_R&(0x10)) == 0x00000000)
	{
		
	}
	if ((GPIO_PORTF_DATA_R&(0x10)) == 0x00000010)
	{
		//Delay1ms(250);
		//GPIO_PORTF_DATA_R |= 0x08;
		//ClearReady();
